...
Usage example:
    from WinDialog import Label

    # Create a  control
    label1 = Label('Simple label', (50, 10), (5, 4))
...
class Label(Control):
    ...
    Attributes:
        ...
        windowClass (str): The window class name of the label control. Default value is 'Static'.
    """
    style: int = SS.SIMPLE | WS.CHILD | WS.VISIBLE
    windowClass: str = 'Static'
